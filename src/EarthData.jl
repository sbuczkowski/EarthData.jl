...
export earthdata_get_s3credentials, curl_write_cb
...
function earthdata_get_s3credentials(aws::AWSCredentials)::AWSCredentials
...
aws.access_key_id = j["access_key_id"]
aws.secret_key = j["secret_key"] 
aws.expiry = DateTime(ZonedDateTime(j["expiration"], "yyyy-mm-dd HH:MM:SSzzzz"))
aws.renew = earthdata_get_s3credentials
